...
# chord)
SD_BIN_WEIGHT=8 SD_H=1024 SD_W=4096 YSCALE=log FMAX=10000 TMAX=7.5 PYTHONPATH=. NFFT=4096 INFILE=sounds/sucrier_horns-1ch_44.1k.f64 FS=44100 SAMPTYPE=float64 python3 scripts/time_series_specgram.py 
